"""
Django settings for HighlightPage_Project project.
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'HighlightPage_Project/media')	# Internal hierarchy
ROOT_URLCONF = 'HighlightPage_Project.urls'
...
MIDDLEWARE = [
	...
	'HighlightPage_Project.middleware.LoginRequriedMiddleware',	# Our custom middleware
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'HighlightPage_Project/templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'HighlightPage_Project.wsgi.application'
